...
If you discover a potential security vulnerability in Local Coding Agent, please report it responsibly:
...
Local Coding Agent is designed specifically to mitigate risks associated with untrusted local model outputs:
